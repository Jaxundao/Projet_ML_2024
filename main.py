...
def main():
   ...
   vous permettant ainsi d'améliorer leur fidélité et satisfaction. Ce modèle de scoring prédit 
   la probabilité de résiliation pour chaque client et le classe dans une catégorie (churn ou pas).
   Veuillez renseigner les informations suivantes pour voir les prédictions du modèle. 
    """
